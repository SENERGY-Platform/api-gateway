...
build = {
  type = "builtin",
  modules = {
    ["kong.plugins.mockup.access"] = "src/access.lua",
    ["kong.plugins.mockup.handler"] = "src/handler.lua",
    ["kong.plugins.mockup.schema"] = "src/schema.lua",
	["kong.plugins.mockup.json"] = "src/json.lua"
  }
}
